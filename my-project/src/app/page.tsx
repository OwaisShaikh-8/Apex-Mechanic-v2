...
import Step1img from "../assets/images/Step1img.webp";
import Step2img from "../assets/images/Step2img.webp";
import Step3img from "../assets/images/Step3img.webp";
import StepsCard from "@/components/StepsCard";
import TrialDemoCard from "@/components/TrialDemoCard";
 ...
 const stepsData = [
  {
    ...
    heading: (
      <>
        Customer booked an appointment with{" "}
        <span className="text-(--color-primary)">online booking</span>
      </>
    ),
    detail:
      "Figma is a powerful design tool that allows you to create and manage component variants with ease.",
    chips: ["Book Appointment", "Ask for Estimate"],
    img: Step1img,
  },
  {
    stepNo: "Step 2",
    heading: (
      <>
        <span className="text-(--color-primary)">Email & text reminders</span>{" "}
        to keep customer updated
      </>
    ),
    detail:
      "Automated reminders help reduce no-shows and keep customers informed.",
    chips: ["Text messages", "Email reminders", "Updates"],
    img: Step2img,
  },
  {
    stepNo: "Step 3",
    heading: (
      <>
        Send email or text and ask for a{" "}
        <span className="text-(--color-primary)">google review</span>
      </>
    ),
    detail:
      "Collect reviews automatically to improve your online presence and trust.",
    chips: ["Google review", "Increase revenue", "Business growth"],
    img: Step3img,
  },
];
  ...
  return (
    <>
      <main>
        ...
        <section className="trial-demo border-y border-(--color-border)">
          <div className="container border-x border-(--color-border) bg-(--bg-chips) p-[40px] flex gap-[30px]">
          </div>
